import { javaObjSymbol } from './symbols'
...
import { 
  ...
  GameInternalUnits, 
  GameOverData, 
  NetType, CommandHandler as JCommandHandler, 
  AbstractGameModule as JAbstractGameModule, 
  ServerRoom, 
  PlayerHessManage, 
  FileUtils 
} from '../javatypes'
import { SeqArray, ObjMap } from '../struct'




export function simpleProxy<To extends object>(options?: {
...
export const value2javaRules: [(v: { [javaObjSymbol]?: JavaObject } & unknown) => boolean,(v: { [javaObjSymbol]?: JavaObject } & unknown) => JavaObject][] = [
