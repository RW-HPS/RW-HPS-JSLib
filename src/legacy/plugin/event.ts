...
export function registerGlobalEvents(plugin: Plugin, eventManage: unknown) {
...
export function registerEvents(plugin: Plugin, eventManage: unknown) {
  plugin.registerEvents && plugin.registerEvents({
    fire(event) {
      switch (event) {
        case 'PlayerBan':
