...
export type EventType = 'PlayerBan' | 'PlayerChat' | 'PlayerIpBan' | 'PlayerIpUnBan' | 'PlayerJoin' | 'PlayerLeave' | 'PlayerOperationUnit' | 'PlayerUnBan' | 'ServerGameOver' | 'ServerGameStart' | 'ServerHessStartPort';
