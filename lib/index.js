 ...
 * @returns 铁锈，启动！模板插件
 */
function createGameStartHelloTemplate() {
    return {
        registerEvents() {
            return createEvent({
...
var templates = /*#__PURE__*/Object.freeze({
    __proto__: null,
    createGameStartHelloTemplate: createGameStartHelloTemplate,
    createHelloWorldTemplate: createHelloWorldTemplate,
    createWasmTemplate: createWasmTemplate
});
